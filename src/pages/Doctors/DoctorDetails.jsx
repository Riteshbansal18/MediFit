...
const DoctorDetails = () => {
  ...
  const {
    ...
    loading,
    error,
  } = userFetchData(`${BASE_URL}/${id}`); // Changed endpoint structure

  // Added optional chaining to prevent errors if doctor is undefined
  const {
    name = "",
    qualifications = [],
    experiences = [],
      ...
      <div className="max-w-[1170px] px-5 mx-auto">
        ...
        {!loading && !error && doctor && (
          <div className="grid md:grid-cols-3 gap-[50px]">
            ...
            <div>
              <SidePanel
                doctorId={id} // Changed to use the id from URL params
